...
in the Snakefile. Alternatively, you may change the inputDIR
...
in. By default, the inputDIR is "Protocol/data/raw" and
paired-end filenames are expected to present the suffixes
